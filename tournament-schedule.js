...
// 12 Gruppenspiele (Doppel-Round-Robin) + HFs + Platz 3 + Finale
...
// 28 Gruppenspiele (volles Round-Robin) + Platz 3 + Finale
// Field 3 (always youth):
...
// Field 2 youth blocks (Netzhöhen-Wechsel nötig):
...
const SCHEDULE_YOUTH_FINALS = [
  makeEntry({
    id: "j-p3", time: "17:00", field: "2", category: "youth",
    phase: "Spiel um Platz 3", phaseKind: "placement",
    home: { rank: 3 }, away: { rank: 4 },
  }),
  makeEntry({
    id: "j-fin", time: "17:00", field: "3", category: "youth",
    phase: "Finale", phaseKind: "final",
